...
export const FlowContainer = ({
  ...
  const backButtonTitle = localizedCustomBackButtonTitle
    ? localizedCustomBackButtonTitle
      ...
      <div className="flex items-center">
        ...
        >
          <BackArrow
            width="44"
            height="44"
            className="p-3 absolute top-1/2 start-1/4 transform -translate-y-1/2 ltr:-translate-x-1/2 rtl:translate-x-1/2 rtl:-scale-x-100 fill-current"
          />
        </button>
